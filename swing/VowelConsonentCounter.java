...
public class VowelConsonentCounter extends JFrame implements KeyListener{
    
    private Container c;
    private JLabel TLabel,aLabel,eLabel,iLabel,oLabel,uLabel,totalVowel,totalLatter;
    private JTextArea a;
    private Font f;
    ...
    public void keyPressed(KeyEvent ke) {
        if(ke.getSource() == a)
        {
            ...
            totalLatter.setText("Total number of consonent : "+Latter);
    ...
    public static void main(String[] args) {
        VowelConsonentCounter frame = new VowelConsonentCounter();
