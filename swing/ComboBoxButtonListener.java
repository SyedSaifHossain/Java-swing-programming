...
public class ComboBoxButtonListener extends JFrame{
    ...
    public static void main(String[] args) {
        ComboBoxButtonListener frame = new ComboBoxButtonListener();
